...
var GROUNDS_WITH_OVERLAYS = {
	...
	# ---
	'Soil0': {c = [[0, 0], [0, 2], [0, 4]], s = 0.2, t = 'Soil1'},
	'Soil1': {c = [[1, 0], [1, 2], [1, 4]], s = 0.2, t = 'Soil2'},
	'Soil2': {c = [[2, 0], [2, 2], [2, 4]], s = 0.2, t = 'Empty'},
	'SoilF': {c = [[3, 0], [3, 2], [3, 4]], s = 0.15, t = 'Empty'},
	'Rock0': {c = [[0, 1], [0, 3], [0, 5]], s = 0.2, t = 'Rock1'},
	'Rock1': {c = [[1, 1], [1, 3], [1, 5]], s = 0.3, t = 'Rock2'},
	'Rock2': {c = [[2, 1], [2, 3], [2, 5]], s = 0.2, t = 'Rock3'},
	'Rock3': {c = [[3, 1], [3, 3], [3, 5]], s = 0.5, t = 'Rock4'},
	...
	'SoilP2': {c = [[2, 0+6], [2, 2+6], [2, 4+6]], s = 0.15, t = 'Empty'},
	'SoilPF': {c = [[3, 0+6], [3, 2+6], [3, 4+6]], s = 0.15, t = 'Empty'},
